...
成功截图，然后会生成一个decrypt_file.exe_extracted的文件，文件里面有一个decrypt_file_1.pyc文件，我们需要把这个文件反编译。先pip install uncompyle6,然后cmd到decrypt_file_1.pyc目录下，输入
...
45	被加密文档中，FLAG1的值是
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTgzMjkxMjUwNCwxNTYwMTA5OTMwLDE1NT
